...
class House:
    ...
    def __str__(self):
        cprint('In house amount of money {}, food in fridge {},amount of dirt {}'.format(self.amount_money, self.food_fridge,
                self.amount_dirt), color='green')
...
class Wife(Human):
    ...
    def shopping(self):
        self.fullness -= 10
        self.house.food_fridge += 100
        self.house.amount_money -= 100
